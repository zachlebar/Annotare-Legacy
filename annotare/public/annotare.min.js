...
return html};return Document}();module.exports=Document}).call(this)});
...
this.type+'">'+text+'<span id="note-detail-'+this.id+'" class="note-detail">'+this.attachment+"</span></span>";else note='<span id="note-'+this.id+'" class="'+this.type+'">'+text+"</span>";html=html.replace(text,note)}return html};return Annotation}();module.exports=Annotation}).call(this)});
...
Flakey=require("flakey");$=Flakey.$;Document=require("../models/Document");List=function(){__extends(List,Flakey.controllers.Controller);function List(config){this.render=__bind(this.render,this);this.id="list-view";this.class_name="list view";this.actions={"click .document":"select_doc"};List.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("list",require("../views/list"))}List.prototype.render=function(){var context;this.documents=Document.all();context={list:this.documents};
this.html(this.tmpl.render(context));this.unbind_actions();return this.bind_actions()};List.prototype.select_doc=function(event){var id;id=$(event.currentTarget).attr("id").replace("document-","");return window.location.hash="#/detail?"+Flakey.util.querystring.build({id:id})};return List}();module.exports=List}).call(this)});
...
__obj.safe=__objSafe,__obj.escape=__escape;return __out.join("")}}).call(this)});
require.define("/controllers/detail.js",function(require,module,exports,__dirname,__filename){(function(){var $,Detail,Document,Flakey,apprise,settings,ui;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;
return child};Flakey=require("flakey");$=Flakey.$;apprise=require("../lib/apprise-1.5.full");ui=require("../lib/uikit");settings=require("../settings");Document=require("../models/Document");Detail=function(){__extends(Detail,Flakey.controllers.Controller);function Detail(config){this.annotate=__bind(this.annotate,this);this.highlight=__bind(this.highlight,this);this["delete"]=__bind(this["delete"],this);this.edit=__bind(this.edit,this);this.render=__bind(this.render,this);this.id="detail-view";this.class_name=
"detail view";this.actions={"click .edit":"edit","click .highlighter":"highlight","click .annotate":"annotate","click .delete":"delete"};Detail.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("detail",require("../views/detail"))}Detail.prototype.render=function(){var context;if(!this.query_params.id)return;this.doc=Document.get(this.query_params.id);context={doc:this.doc};this.html(this.tmpl.render(context));this.unbind_actions();return this.bind_actions()};Detail.prototype.edit=
...
_this.doc.slug).html(html)}})}};return Detail}();module.exports=Detail}).call(this)});
...
return child};Flakey=require("flakey");$=Flakey.$;autoresize=require("../lib/autoresize");ui=require("../lib/uikit");settings=require("../settings");Document=require("../models/Document");Edit=function(){__extends(Edit,Flakey.controllers.Controller);function Edit(config){this.discard=__bind(this.discard,this);this.save=__bind(this.save,this);this.id="edit-view";this.class_name="edit_document view";this.actions={"click .save":"save","click .discard":"discard"};Edit.__super__.constructor.call(this,
config);this.tmpl=Flakey.templates.get_template("edit",require("../views/edit"))}Edit.prototype.render=function(){var context;if(!this.query_params.id)return;this.doc=Document.get(this.query_params.id);context={doc:this.doc};this.html(this.tmpl.render(context));this.unbind_actions();this.bind_actions();return $("#editor").autoResize({extraSpace:100,maxHeight:1E4}).blur()};Edit.prototype.save=function(){this.doc.base_text=$("#editor").val();this.doc.save();ui.info("Everything's Shiny Capt'n!",'"'+
this.doc.name+'" was successfully saved.').hide(settings.growl_hide_after).effect(settings.growl_effect);return window.location.hash="#/detail?"+Flakey.util.querystring.build(this.query_params)};Edit.prototype.discard=function(params){return ui.confirm("There be Monsters!","Careful there Captain; are you sure you want to discard all changes to this document?").show(function(ok){if(ok)return window.location.hash="#/list"})};return Edit}();module.exports=Edit}).call(this)});
...
require.define("/controllers/history.js",function(require,module,exports,__dirname,__filename){(function(){var $,Document,Flakey,History,Showdown,apprise;var __bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;
return child};Flakey=require("flakey");$=Flakey.$;Showdown=require("../lib/showdown");apprise=require("../lib/apprise-1.5.full");Document=require("../models/Document");History=function(){__extends(History,Flakey.controllers.Controller);function History(config){this.update=__bind(this.update,this);this.render=__bind(this.render,this);this.id="history-view";this.class_name="history view";this.actions={"change #version-input":"update"};History.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("history",
...
require.define("/index.js",function(require,module,exports,__dirname,__filename){(function(){var $,Annotare,App,Flakey;var __hasProp=Object.prototype.hasOwnProperty,__extends=function(child,parent){for(var key in parent)if(__hasProp.call(parent,key))child[key]=parent[key];function ctor(){this.constructor=child}ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};Flakey=require("flakey");$=window.$=Flakey.$;Annotare=require("./controllers/annotare");
