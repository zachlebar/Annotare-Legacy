...
require("flakey");$=Flakey.$;Document=require("../models/Document");List=function(_super){__extends(List,_super);function List(config){this.search=__bind(this.search,this);this.new_document=__bind(this.new_document,this);this.render=__bind(this.render,this);this.id="list-view";this.class_name="list view";this.actions={"click .document":"select_doc","click .new-document":"new_document","keyup #search-box":"search"};List.__super__.constructor.call(this,config);this.tmpl=Flakey.templates.get_template("list",
...
return this.bind_actions()}};return Detail}(Flakey.controllers.Controller);module.exports=Detail}).call(this)});
...
return Edit}(Flakey.controllers.Controller);module.exports=Edit}).call(this)});
