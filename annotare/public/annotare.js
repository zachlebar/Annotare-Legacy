  ...
  this.ecoTemplates["list"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        if (this.query) {
          __out.push('\n\t\t<small>Would you like to create a new document entitled "');
...
(function() {
  var $, Annotation, Detail, Document, Flakey, ui,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  Detail = (function(_super) {
    ...
    Detail.prototype.highlight = function(event) {
      ...
      if (selection.length === 0) {
        return ui.error('Well, you were right about this being a bad idea.', 'Please select some text first.').hide(5000).effect('slide');
      } else {
...
(function() {
  ...
  Edit = (function(_super) {
    ...
    function Edit(config) {
      ...
      this.render = __bind(this.render, this);      this.id = "edit-view";
