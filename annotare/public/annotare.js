...
(function() {
  var $, Detail, Edit, Flakey, List, Main, NewDocument,
...
(function() {
  var $, Document, Flakey, NewDocument, autoresize,
...
(function() {
  var $, Detail, Document, Flakey, apprise,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  Detail = (function(_super) {
    ...
    Detail.prototype.highlight = function(event) {
      ...
      if (selection.length === 0) {
        return apprise('Please select some text first');
      } else {
...
(function() {
  var $, Document, Edit, Flakey, autoresize,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
